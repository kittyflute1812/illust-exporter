...
def main():
    ...
    parser.add_argument("output_types", nargs="+", help="Output types (e.g., pixiv, other)")
    ...
    for output_type in args.output_types:
        ...
        output_path = os.path.join(os.path.dirname(args.folder_path), output_folder_name)
        ...
        for filename in os.listdir(output_path):
            if filename.lower().endswith(".psd"):
                ...
                jpeg_path = os.path.join(output_path, f"{os.path.splitext(filename)[0]}.jpeg")
